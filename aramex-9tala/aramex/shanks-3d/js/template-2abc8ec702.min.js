...
var ccHelpers=function(e){"use strict";function t(e,t){r(!0)}function n(e,t){}function o(e,t,n){c(null)}function i(t,n,o){if(t&&t.ResponseType)switch(t.MaximumResendsReached&&(e("#MaximumResendsReachedMessage").show(),e("#ResendLink").hide()),t.ResponseType){case O.message:r(!1),T(t.Message),ccHelpers.resetTimeout("ValidateTimeout"),ccOtpHelper.otpResendcooldown(),a(t),ccHelpers.shouldPoll=!0;break;case O.nextStep:default:u(t)}else t&&"PENDING"==t.NextStep?(r(!1),e("#OOBValidateErrorText").show()):!t||"OUTOFBAND"!=t.Type&&"BIOMETRIC"!=t.Type?c(null):u(t)}function a(e){"undefined"!=typeof onUpdatePageCallBack&&onUpdatePageCallback&&typeof onUpdatePageCallback==typeof Function&&onUpdatePageCallback(e)}function r(t){C=C||e("#ProcessingModal"),t?C.modal("show"):C.modal("hide")}function s(t,n){document.getElementById(t).onclick=function(t){t.preventDefault(),r(!0),"FailWithFeedback"===n||"Error"===n||"Blocked"===n?d({IssuerId:e("#IssuerId").val(),MessageVersion:e("#MessageVersion").val()}):p()}}function u(e){ccHelpers.shouldPoll=!1,e&&e.NextStep&&e.NextStep!==b.term?e.NextStep===b.pending?ccHelpers.shouldPoll=!0:c(e):d(e)}function c(t){var n=e("form").filter(".nextstep-form")[0],o=2==t.MessageVersion||2==e("#MessageVersion").val()?"2_1_0/":"",i="/"+o+t.NextStep;if(null!==t&&void 0!==t){const a=t.LanguageCode?t.LanguageCode:t.OverrideLanguage;if(null!==a&&void 0!==a){var r=document.createElement("input");r.setAttribute("type","hidden"),r.setAttribute("name","languageCode"),r.setAttribute("value",a),n.appendChild(r)}if(null!==t.GroupId&&void 0!==t.GroupId){var s=document.getElementById("GroupId");s.setAttribute("value",t.GroupId)}if(null!==t.Type&&void 0!==t.Type){var u=document.getElementById("Type");u.setAttribute("value",t.Type)}if(null!==t.ChoiceType&&void 0!==t.ChoiceType){var c=document.getElementById("NextStepChoiceType");c.setAttribute("name","ChoiceType"),c.setAttribute("value",t.ChoiceType)}}n.action=i+"/"+t.IssuerId,n.submit()}function l(t){var n=e("#TermForm");2==t.MessageVersion?(n.find("#cres").val(t.CRes),n.find("#threeDSSessionData").val(t.ThreeDSSessionData),n.attr("action",t.NotificationUrl)[0].submit()):(n.find("#PaRes").val(t.PARes),n.find("#MD").val(t.MD),n.attr("action",t.TermUrl)[0].submit())}function d(t){var n={IssuerId:t.IssuerId,NextStep:b.error},o=document.getElementById("NextStepTransactionId")||document.getElementById("TransactionId"),i=e('[name="IssuerId"]').val(),a=2==t.MessageVersion||2==e("#MessageVersion").val()?"2_1_0/":"";r(!0),e.ajax({type:"POST",url:"/api/"+a+"nextstep/term",data:{TransactionId:o.value,IssuerId:i},success:function(e){e&&e.NextStep===b.term?e.Payload?l(e.Payload):c(n):c(e)},error:function(){c(n)}})}function p(){var t=f(),n={IssuerId:t,NextStep:b.error},o=e("#NextStepTransactionId").length?e("#NextStepTransactionId").val():e("#TransactionId").val(),i=2==e("#MessageVersion").val()?"2_1_0/":"";r(!0),e.ajax({type:"POST",url:"/api/"+i+"nextstep/usercancel",data:{TransactionId:o,IssuerId:t},success:function(e){e&&e.NextStep===b.term?e.Payload?l(e.Payload):c(n):c(e)},error:function(){c(n)}})}function f(){var e=window.location.pathname.split("/");return e.length>0?e[e.length-1]:window.location.pathname}function m(){return E=E||e("input").filter("[data-val=true]")}function I(){return M=M||e("#ValidationErrorMessage")}function g(){var e=I();e.text("").css("display","none")}function v(e){var t=I(),n=m();t.text(e.Content).css("display","inline-block"),t.hasClass("field-validation-error")||t.addClass("field-validation-error"),n.on("input",function(e){t.css("display","none"),n.off("input")})}function T(e){if(e)switch(e.Type){case P.successNotification:ccHelpers.showNotification("success",e.Title,e.Content);break;case P.inlineError:default:v(e)}else c(null)}function y(e,t,n){toastr.options={positionClass:"toast-top-full-width",closeButton:!0,extendedTimeout:1e4},toastr[e](n,t)}function h(t){var n=e("#"+t).val();n&&(w=setTimeout(function(){ccHelpers.executeTermStep({IssuerId:e("#IssuerId").val(),MessageVersion:e("#MessageVersion").val()})},n))}function x(e){w&&(clearTimeout(w),w=null),h(e)}function S(){return window.location.protocol+"//"+window.location.hostname+(window.location.port?":"+window.location.port:"")}function N(t,n,o){var i=document.getElementById("TransactionId").value,a=document.getElementById("CredentialId").value,r=document.getElementById("IssuerId").value,s=document.getElementById("MessageVersion").value,u=document.getElementById("Type").value;e.ajax({url:"/Api/OutOfBand/ValidateOutOfBandCredential",method:"POST",data:{TransactionId:i,CredentialId:a,IssuerId:r,MessageVersion:s,Type:u,Origin:t},success:n,beforeSend:o})}var C,E,M,w,B={},P={inlineError:"InlineError",successNotification:"SuccessNotification"},b={error:"ERROR",pending:"PENDING",term:"TERM"},O={message:"Message",nextStep:"NextStep"},R=!0;return B.ajax={onBegin:function(e,n){return t(e,n)},onComplete:function(e,t){return n(e,t)},onFailure:function(e,t,n){return o(e,t,n)},onSuccess:function(e,t,n){return i(e,t,n)}},B.error={hideInline:function(){return g()},showInline:function(e){return v(e)}},B.processingModal=function(e){return r(e)},B.registerExitClick=function(e,t){return s(e,t)},B.submitNextStepForm=function(e){return c(e)},B.doNextStep=function(e){return u(e)},B.executeTermStep=function(e){return d(e)},B.getIssuerIdFromUrl=function(){return f()},B.showNotification=function(e,t,n,o){y(e,t,n,o)},B.setupTimeout=function(e){h(e)},B.resetTimeout=function(e){x(e)},B.getProtocolAndHost=function(){return S()},B.validateOutOfBandCredential=function(e,t,n){N(e,t,n)},B.shouldPoll=R,B}(jQuery);"undefined"!=typeof exports&&(module.exports.ccHelpers=ccHelpers);
$(function(){if($(".modal").filter(".accordion").on("hidden.bs.modal",function(o){$(this).find(".collapse").collapse("hide")}),$(".modal").not("#ThreeDsModal")){var o=$(".body").attr("dir");"RTL"===o&&($(".modal").addClass("rtl"),$(".modal-header").children("button").css("float","left"))}$(".body").css("bottom",$(".sticky-footer").height()),$(".accordion").on("click",function(o){$(this).next().hasClass("in")?$(this).next().slideUp():($(this).next().slideDown(),$(".collapse.in").slideUp(),$("html, body").animate({scrollTop:$(document).height()/3}))})});
var ccOtpHelper=function(e){"use strict";function n(e,n){e.value!==n.href&&(e.value=n.href),n.href="JavaScript:Void(0)"}function t(){resendLinkTemp.value&&(ResendLink.title="",ResendLink.href=resendLinkTemp.value)}function i(e,n){var t=document.getElementById("resendLinkTooltipText"),i=t.value;e.title=i.replace("{1}",n)}function r(e,n,t){e.appendChild(t),e.appendChild(n)}function o(n,t,i,r,o){var d=n/t*i;e(r).animate({width:d},function(){n<=0&&(linkContainer.removeChild(r),linkContainer.removeChild(o))})}function d(e){return!!e}function l(e){var n=[];const t=function(e){return e===!0};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&n.push(d(e[i]));return!("undefined"==typeof n||null===n||!n.every(t))}function u(){var e={linkContainer:document.getElementById("linkContainer"),ResendLink:document.getElementById("ResendLink"),resendLinkTemp:document.getElementById("resendLinkTemp")};if(l(e)){var d=0,u=document.getElementById("OtpResendTimeout").value,a=0,c=e.ResendLink.offsetWidth,s=e.ResendLink.offsetHeight,f=5,k=document.createElement("linkMask"),p=document.createElement("blockMask"),m=function(){return u?u/1e3:a};if(m()>0){k.setAttribute("id","linkMask"),k.style.width=c+"px",k.style.height=s+f+"px",p.setAttribute("id","blockMask"),p.style.width=c+"px",p.style.height=s+f+"px",n(e.resendLinkTemp,e.ResendLink),r(e.linkContainer,k,p),d=m();var v=setInterval(function(){var n=m()-d;i(e.ResendLink,d),i(k,d),o(d,m(),c,k,p),d-=1,n>=m()&&(clearInterval(v),t())},1e3)}}}return{otpResendcooldown:function(){u()}}}(jQuery);
var updatePageHelper=function(e){"use strict";function n(e){var n=document.getElementById("referenceCode");n&&e.ReferenceCode&&(n.innerText=e.ReferenceCode)}function t(e){var n=document.getElementById("contentBlock-text"),t="";if(n&&e.Credentials){for(var r=0;r<e.Credentials.length;r++)t+=e.Credentials[r].Text;n.innerText=t}}function r(e){var n=document.getElementById("contentBlock-type"),t="";if(n&&e.Credentials){for(var r=0;r<e.Credentials.length;r++)t+=e.Credentials[r].Type;n.innerText=t}}function a(e){var n=document.getElementById("Credential_Id");n&&e.Credentials&&(n.value=e.Credentials[0].Id)}function d(e){n(e),"False"==document.getElementById("ValidateReloadEnabled").value&&(t(e),r(e),a(e))}return{onUpdatePageCallback:function(e){d(e)}}}(jQuery);
//# sourceMappingURL=template-2abc8ec702.min.js.map